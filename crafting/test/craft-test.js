...
describe("Craft", function () {
  ...
  it("should start as incomplete", function () {
    ...
    var paper = new Material("paper", 0.25, 10, "sheets");
  ...
  it("should be able to complete craft", function () {
    var fabric = new Material("fabric", 4, 0.5, "yards");
    var thread = new Material("thread", 0.25, 10, "spools");
    var embroidery = new Craft({
      type: "embroidery",
